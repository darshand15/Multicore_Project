...
malloc_values = [0.00802367, 0.49239, 0.0427148]
hoard_values = [0.00841259, 0.49245, 0.0405679]
my_mem_alloc_values = [0.00798311, 0.497155, 2.61266]
...
ax.set_title('Speed Comparison of Memory Allocators (Single Threaded)', fontweight='bold')
ax.set_xticks(x)
...
plt.savefig('single_threaded_speed.png', dpi=300, bbox_inches='tight')
